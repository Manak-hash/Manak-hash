...
UIC student with a passion for building scalable, intelligent solutions. I specialize in:

- 🌐 **Full-Stack Development** – Modern web applications and complex web platforms
- 🤖 **AI Automation & Wrappers** – Integrating AI capabilities into production-ready systems
- ⚙️ **Complex Automation** – Streamlining workflows and building intelligent automation pipelines
- 🏗️ **System Architecture** – Designing robust, maintainable codebases from scratch

Currently mixing academic learning with real projects that solve actual problems.
